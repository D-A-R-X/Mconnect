...
class CollectionRejectBottomSheet : BottomSheetDialogFragment() {
    ...
    ): View = inflater.inflate(R.layout.sheet_collection_reject, container, false)
    ...
    companion object {
        const val RESULT_KEY = "CollectionRejected"
        fun newInstance(itemId: String) = CollectionRejectBottomSheet().apply {
